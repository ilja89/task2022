<template>
    <div class="student-overview-container">
        ...
        <page-title :title="charonName" :edit-charon-settings="true"></page-title>
        ...
        <submission-graph-section :graphDataEveryDay="graphDataEveryDay"
                                  :graph-data-today="graphDataToday"></submission-graph-section>

        <charon-defense-registrations-section :defense-list="defenseList"
                                              :teachers="teachers"></charon-defense-registrations-section>
