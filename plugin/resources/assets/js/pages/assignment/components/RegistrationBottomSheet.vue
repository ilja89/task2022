        ...
        <div>
            ...
            <v-sheet style="position:relative;" class="px-4 pt-4" height="80vh">
                ...
                <v-row class="mt-4">
                    ...
                    <v-btn class="ml-4" color="primary" dense outlined text @click="test()">TEST
                    </v-btn>
                </v-row>
...
export default {
    ...
    methods: {
        test(){
          axios.get(`api/charons/${this.charon_id}/getLabBeforeStarted?lab_id=8&user_id=${this.student_id}`).then(result => {
