<template>
  <v-app style="background: lightgray">
    <v-main>
      ...
      <charon-dashboard-header/>

      <charon-dashboard-navigation/>

      <charon-dashboard-body/>
...
<script>
import {CharonDashboardHeader, CharonDashboardBody, CharonDashboardNavigation} from './layouts'
import {Loader} from '../popup/partials'
import Charon from "../../api/Charon";
import {mapState} from "vuex";

export default {

  components: {CharonDashboardHeader, CharonDashboardBody, Loader, CharonDashboardNavigation},
  ...
  created() {
    ...
    document.title = 'Charon dashboard: ' + window.course_name;
