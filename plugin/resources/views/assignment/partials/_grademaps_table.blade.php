        ...
        <table class="table is-bordered">
            ...
            <tr>
                ...
                <td>
                    ...
                    |
                    {{ $charon->userGrade ? floatval($charon->userGrade->finalgrade / $charon->maxGrade * 100) : '0' }}%
                </td>
            </tr>
            </tfoot>
            <tbody>
            ...
            @foreach ($charon->grademaps as $grademap)
                <tr>
                    ...
                    <td>
                        ...
                        |
                        {{ $charon->userGrade ? floatval($grademap->userGrade->finalgrade / $grademap->gradeItem->grademax * 100) : '0' }}%
                    </td>
                </tr>
            @endforeach
            </tbody>
