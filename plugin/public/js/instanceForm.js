...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__EmitEventOnInputChange__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Translate__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__FormElement__ = __webpack_require__(76);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Charon__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Comment__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__File__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Output__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Preset__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Submission__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__User__ = __webpack_require__(49);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(7), __webpack_require__(68)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CharonFieldset_vue__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CharonNumberInput_vue__ = __webpack_require__(93);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CharonSelect_vue__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__CharonTextInput_vue__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__GradesCheckboxes_vue__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__InstanceFormFieldset_vue__ = __webpack_require__(97);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CharonTab_vue__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CharonTabs_vue__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Datepicker_vue__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__FilesComponent_vue__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Modal_vue__ = __webpack_require__(58);
...
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_2__Datepicker_vue___default.a; });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_datepicker__ = __webpack_require__(53);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getFiles() {
            __WEBPACK_IMPORTED_MODULE_0__models__["b" /* File */].findBySubmission(this.submission.id, files => {
                this.files = files;
                if (files.length > 0) {
...
class Charon {
    ...
    static all(courseId, then) {
        axios.get('/mod/charon/api/courses/' + courseId + '/charons').then(response => {
            then(response.data);
        }).catch(error => {
    ...
    static getResultForStudent(charonId, userId, then) {
        axios.get('/mod/charon/api/charons/' + charonId + '/results/' + userId).then(response => {
            then(response.data);
        }).catch(error => {
...
class Comment {
    ...
    static all(charonId, studentId, then) {
        axios.get('/mod/charon/api/charons/' + charonId + '/comments', { params: { student_id: studentId } }).then(response => {
            then(response.data);
        }).catch(error => {
...
class File {
    ...
    static findBySubmission(submissionId, then) {
        axios.get('/mod/charon/api/submissions/' + submissionId + '/files').then(({ data }) => {
            then(data);
        }).catch(error => {
...
class Output {
    ...
    static findBySubmission(submissionId, then) {
        axios.get('/mod/charon/api/submissions/' + submissionId + '/outputs').then(({ data }) => {
            then(data);
        }).catch(error => {
...
class Submission {
    ...
    static findByUserCharon(userId, charonId, then) {
        axios.get('/mod/charon/api/charons/' + charonId + '/submissions', { params: { user_id: userId } }).then(({ data }) => {
    ...
    static getNext(then) {
        axios.get(Submission.nextUrl).then(({ data }) => {
            Submission.nextUrl = data.next_page_url;
            then(data.data);
        }).catch(error => {
            VueEvent.$emit('show-notification', 'Error retrieving submissions.', 'danger');
    ...
    static update(charonId, submission, then) {
        axios.post('/mod/charon/api/charons/' + charonId + '/submissions/' + submission.id, { submission: submission }).then(response => {
            then(response.data);
        }).catch(error => {
    ...
    static findById(charonId, submissionId, then) {
        axios.get('/mod/charon/api/charons/' + charonId + '/submissions/' + submissionId).then(response => {
            then(response.data);
        }).catch(error => {
    ...
    static addNewEmpty(charonId, studentId, then) {
        axios.post('/mod/charon/api/charons/' + charonId + '/submissions/add', { student_id: studentId }).then(response => {
            then(response);
        }).catch(error => {
...
class User {
    ...
    static findById(courseId, userId, then) {
        axios.get('/mod/charon/api/courses/' + courseId + '/users/' + userId).then(({ data }) => {
            then(data);
        }).catch(error => {
    ...
    static getReportTable(courseId, userId, then) {
        axios.get('/mod/charon/api/courses/' + courseId + '/users/' + userId + '/report-table').then(({ data }) => {
            then(data);
        }).catch(error => {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = CourseSettingsForm;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = InstanceFormForm;
...
class PopupContext {
    ...
    initializeEventListeners() {
        ...
        VueEvent.$on('submission-was-saved', () => {
            __WEBPACK_IMPORTED_MODULE_0__models__["a" /* Submission */].findById(this.active_charon.id, this.active_submission.id, submission => {
                this.active_submission = submission;
            });
        });
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = PopupContext;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CourseSettingsForm__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__InstanceForm__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PopupContext__ = __webpack_require__(73);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DeadlineRow_vue__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__GrademapRow_vue__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__InstanceForm_vue__ = __webpack_require__(176);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__classes__ = __webpack_require__(74);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sections__ = __webpack_require__(161);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_partials__ = __webpack_require__(17);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { Datepicker: __WEBPACK_IMPORTED_MODULE_0__components_partials__["e" /* Datepicker */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_partials__ = __webpack_require__(17);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AdvancedGradingSection_vue__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AdvancedTaskInfoSection_vue__ = __webpack_require__(180);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DeadlineSection_vue__ = __webpack_require__(181);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__SimpleGradingSection_vue__ = __webpack_require__(182);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__SimpleTaskInfoSection_vue__ = __webpack_require__(183);
