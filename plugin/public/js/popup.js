...
module.exports={render:function (){var _vm=this;
  return _vm._c('popup-section', {
  ...
  }, [_vm._v(_vm._s(_vm._f("datetime")(_vm.submission.git_timestamp.date)))]), _vm._v(" "), (_vm.hasDeadlines) ? _vm._c('div', {
    ...
    return _vm._c('li', [_vm._v(_vm._s(_vm._f("datetime")(deadline.deadline_time.date)) + " - " + _vm._s(deadline.percentage) + "%")])
...
module.exports={render:function (){var _vm=this;
  ...
  }), _vm._v(" "), (_vm.canLoadMore) ? _vm._c('div', {
    staticClass: "has-text-centered"
  }, [_vm._c('button', {
    staticClass: "button is-primary",
    on: {
